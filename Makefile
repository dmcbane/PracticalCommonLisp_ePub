...
GENERALOPTS = --standalone --table-of-contents --epub-cover-image=cover.jpg -M title:"Practical Common Lisp" -M author:"Peter Seibel" -M date:"June 29, 2012 - Build ${BUILD}"
